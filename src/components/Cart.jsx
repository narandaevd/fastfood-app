            ...
            <div className="cart__top">
              <h2 className="content__title">
                ...
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span onClick={props.onResetCart}>Очистить корзину</span>
                </div>
            </div>
            <div className="content__items">

            { 
                _.isEmpty(props.cart.items) ? 
                    <CartEmpty /> 
                : 
                    props.cart.items.map(item => <CartItem cartItemData={item}/>) 
            }

            </div>
            <div className="cart__bottom">
                <div className="cart__bottom-details">
                    <span> Всего пицц: <b>{props.cart.totalItems} шт.</b> </span>
                    <span> Сумма заказа: <b>{props.cart.totalPrice} ₽</b> </span>
                </div>
